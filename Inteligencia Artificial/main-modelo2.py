...
if __name__ == "__main__":
    ...
    dimension_embedding = 200  # Aumentado
    unidades_lstm = 256  # Aumentado

    # Definición de F1-score personalizado
    ...
    f1 = f1_score(y_true, y_pred_classes, average='weighted')  # Usando sklearn
